...
<section class="update-product">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <span>Modificar Categoria</span>
      <select name="category" class="box" required>
         <option selected value="<?= $fetch_products['category']; ?>"><?= $fetch_products['category']; ?></option>
         <option value="main dish">Comidas Rapidas</option>
         <option value="fast food">Platos Principales</option>
         <option value="drinks">Escabio</option>
         <option value="desserts">Postres</option>>
      </select>
      <span>Modificar Descripcion</span>
      <input type="text" min="0" max="9999999999" required placeholder="Ingrese Descripcion" name="description" onkeypress="if(this.value.length == 500) return false;" class="box" value="<?= $fetch_products['description']; ?>">
